...
screen.title("Pong by Russell, Ben, and Wesley ")
screen.bgcolor("blue")
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Russell: 0 Ben: 0", align="center", font=("Courier", 20, "normal"))
def paddle_a_up():
   y = paddle_a.ycor()
   y += 30
   paddle_a.sety(y)
...
while True:
   ...
   if (ball.xcor() < -340 and ball.xcor() > -350) and (paddle_a.ycor() + 50 > ball.ycor() > paddle_a.ycor() - 50):
       score_a += 1
       pen.clear()
       pen.write("Russell: {} Ben: {}".format(score_a, score_b), align="center", font=("Courier", 20, "normal"))
   if ball.xcor() > 380:
       score_a = 0
       pen.clear()
       pen.write("Russell: {} Ben: {}".format(score_a, score_b), align="center", font=("Courier", 20, "normal"))
